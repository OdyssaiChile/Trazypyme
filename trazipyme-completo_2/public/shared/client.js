...
async function trazi_getProfile() {
  ...
  const { data, error } = await sb
    .from('profiles')
    .select('id, nombre, email, role, activo, tenant_id, tenants(id, nombre, plan, subscription_status, trial_ends_at, current_period_end, bodegas_incluidas, precio_base_clp, precio_bodega_adicional_clp, mp_preapproval_id)')
